...
const ALLOWED_CHANNELS = {
    ...
    invoke: ['open-external', 'open-pdf-window', 'open-pdf-with-system-app', 'get-app-config', 'get-connection-config', 'get-server-config', 'get-workspace-config', 'set-workspace-config', 'get-local-ip', 'get-system-info', 'list-folders', 'open-path', 'launch-app', 'get-app-icon', 'generate-lot-pdf', 'generate-disques-pdf', 'generate-commande-pdf', 'generate-don-pdf', 'read-file-as-base64', 'run-lsblk'],
